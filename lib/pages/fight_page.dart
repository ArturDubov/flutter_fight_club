...
class FightPageState extends State<FightPage> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ActionButton(
              text:
              yoursLives == 0 || enemysLives == 0 ? "Back" : "Go",
              onTap: _onGoButtonClicked,
              color: _getGoButtonColors(),
            ),
            SizedBox(height: 16),
          ],
        ),
  ...
  void _onGoButtonClicked() {
    if (yoursLives == 0 || enemysLives == 0) {
      ...
      setState(() {
        ...
        final FightResult? fightResult = FightResult.calculateResult(yoursLives, enemysLives);
        if (fightResult != null) {
  ...
  String _calculateCenterText(final bool youLoseLife, final bool enemyLoseLife) {
    ...
    if (enemysLives == 0 && yoursLives == 0) {
      return "Draw";
    } else if (yoursLives == 0) {
      return "You lost";
